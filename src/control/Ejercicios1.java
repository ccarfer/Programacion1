...
public class Ejercicios1 {
	...
	public static void main(String[] args) {
		...
		// ej1.adivinaNumero();
		// String[] nombres = ("carlos", "Pablo","Andres");

		/*
		 * int[] numeros1 = { 3, 1, 2, 5, 4, 6, 99 };
		 * ej1.ordenaListaNumero(numeros); boolean encontrado =
		 * ej1.busquedaBinarea(99, numeros); if (encontrado)
	...
	// ---------------------------------------------------------------------------------------------------------------------
	public boolean busquedaBinarea(int buscame, int[] enDonde) {
		int min, max, medio;
		min = 0;
		max = enDonde.length - 1;
		while (min <= max) {
			medio = min + (max - min) / 2;
			if (enDonde[medio] == buscame)
				return true;
			else if (enDonde[medio] > max) {
				max = medio;
			} else
				min = medio;
		}
	...
	// ---------------------------------------------------------------------------------------------------------------------
	public void ordenaListaNumero(int[] lista) {
